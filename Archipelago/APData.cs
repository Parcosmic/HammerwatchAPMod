...
namespace HammerwatchAP.Archipelago
{
    public static class APData
    {
        ...
        public static readonly string[] trapLinkCustomTraps = new string[]
        {
            "home_tp_trap",
            "ap_beetle_tp_trap",
            "explore_speed_trap",
        ...
        public static readonly Dictionary<string, string> trapLinkInterpretNames = new Dictionary<string, string>()
        {
            ...
            { "Attraction Breakdown Trap", "Disarm Trap" },
            { "Attraction Voucher Trap", "Banner Trap" },
            { "Bald Trap", "Mana Drain Trap" },
            { "Banana Peel Trap", "Stun Trap" },
            { "Banana Trap", "Stun Trap" },
            { "Bathroom Trap", "explore_speed_trap" },
            { "Bee Trap", "Chaser Trap" },
            { "Blango Artillery", "Frost Trap" },
            { "Blastoad", "Bomb Trap" },
            { "Blue Balls Curse", "Bomb Trap" },
            { "Bomb", "Bomb Trap" },
            { "Bonk Trap", "Stun Trap" },
            { "Breakout Trap", "Hey! Trap" },
            { "Bubble Trap", "Stun Trap" },
            { "Bullet Time Trap", "Frost Trap" },
            { "Burger Hat Trap", "Hey! Trap" },
            { "Burn Trap", "Fire Trap" },
            { "Buyon Trap", "Chaser Trap" },
            { "Camera Trap", "Confuse Trap" },
            { "Camera Rotate Trap", "Confuse Trap" },
            { "Chameleos Spit", "Confuse Trap" },
            { "Chaos Trap", "crt_trap" },
            ...
            { "CRT Trap", "crt_trap" },
            { "Crystal Trap", "Hey! Trap" },
            { "Curse Trap", "Frost Trap" },
            { "Cursed Trap", "1hp_trap" },
            { "Cursed Ball Trap", "Confuse Trap" },
            { "Cutscene Trap", "Hey! Trap" },
            //{ "Dad Trap", "" },
            { "Damage Trap", "Bomb Trap" },
            { "Dead Ringer Trap", "Chaser Trap" },
            { "Deisometric Trap", "crt_trap" },
            { "Depletion Trap", "Mana Drain Trap" },
            { "Depression Trap", "Frost Trap" },
            ...
            { "E. Gadd Ramblings", "Hey! Trap" },
            { "Earth Trap", "Stun Trap" },
            { "Egg Trap", "Banner Trap" },
            ...
            { "Enchantment Trap", "explore_speed_trap" },
            { "Enemy Ball Trap", "Confuse Trap" },
            { "Energy Drain Trap", "Mana Drain Trap" },
            //{ "Expensive Stocks", "" },
            { "Explosion Trap", "Bomb Trap" },
            { "Exposition Trap", "Hey! Trap" },
            { "Extreme Chaos Trap", "crt_trap" },
            //{ "Fake Transition", "" }, //Can do the black fade out? Will have to manually emulate the combination of AddParallaxLayer and RemoveParallaxLayer
            { "Farcaster", "home_tp_trap" },
            { "Fast Trap", "explore_speed_trap" },
            { "Fat CJ Trap", "Frost Trap" },
            { "Fear Trap", "camera_shake_trap" },
            { "Fish Eye Trap", "curvature_trap" },
            { "Fishing Trap", "Disarm Trap" },
            { "Fishin' Boo Trap", "Chaser Trap" },
            //{ "First Person Trap", "" },
            { "Flint Trap", "Chaser Trap" },
            { "Flip Horizontal Trap", "Confuse Trap" },
            { "Flip Trap", "Confuse Trap" },
            { "Flip Vertical Trap", "Confuse Trap" },
            //{ "Flood Trap", "" }, //Would be funny if we could disable the pumps and re-flood levels, doubtful it would be worth the effort though
            { "Food poisoning Trap", "Poison Trap" },
            { "Fracture Trap", "Hey! Trap" },
            ...
            { "Gadget Shuffle Trap", "Disarm Trap" },
            ...
            //{ "Gravity Trap", "" },
            { "Guest Bathroom Trap", "explore_speed_trap" },
            { "Guest Happiness Trap", "Disarm Trap" },
            { "Guest Hunger Trap", "Mana Drain Trap" },
            { "Guest Kill Trap", "Bomb Trap" },
            { "Guest Money Trap", "Mana Drain Trap" },
            { "Guest Spawn Trap", "Chaser Trap" },
            { "Guest Thirst Trap", "Mana Drain Trap" },
            { "Guest Tiredness Trap", "Mana Drain Trap" },
            { "Guest Vandal Trap", "Banner Trap" },
            { "Guest Vomiting Trap", "Poison Trap" },
            { "Gustcrab", "explore_speed_trap" },
            { "Help Trap", "Hey! Trap" },
            { "Hiccup Trap", "Stun Trap" },
            { "Hidden Trap", "Hey! Trap" },
            { "Home Trap", "home_tp_trap" },
            { "Honey Trap", "Frost Trap" },
            //{ "Ice Floor Trap", "" },
            { "Ice Trap", "Frost Trap" },
            { "Icon Trap", "Confuse Trap" },
            { "Icey Hot Pants Trap", "Frost Trap" },
            //{ "Impatience Trap", "" },
            ...
            { "Isometric Trap", "Frost Trap" },
            { "Items to Bombs", "Bomb Trap" },
            { "Jump Trap", "Stun Trap" },
            { "Jumping Jacks Trap", "Stun Trap" },
            { "Laser Trap", "Fire Trap" },
            { "Laughter Trap", "Stun Trap" },
            { "Leaping Trap", "explore_speed_trap" },
            //{ "Light Up Path Trap", "" },
            ...
            { "Modified Bloons Trap", "Banner Trap" },
            { "Monkey Mash Trap", "Confuse Trap" },
            { "Monkey Trap", "Chaser Trap" },
            { "My Turn! Trap", "Confuse Trap" },
            { "Nightmare Trap", "Confuse Trap" },
            { "Ninja Trap", "Chaser Trap" },
            { "No Guarding", "Disarm Trap" },
            { "No Hat", "Disarm Trap" },
            //{ "No Petals", "" },
            //{ "No Revivals", "" },
            { "No Return Trap", "Disarm Trap" },
            //{ "No Stocks", "" },
            { "No Vac Trap", "Disarm Trap" },
            //{ "Number Sequence Trap", "" },
            { "Nut Trap", "Bomb Trap" },
            { "OmoTrap", "Chaser Trap" },
            { "One Hit KO", "Stun Trap" },
            { "One Hit Trap", "Stun Trap" },
            //{ "Paper Trap", "" },
            { "Paralyze Trap", "Stun Trap" },
            { "Paralysis Trap", "Stun Trap" },
            { "Paratoad", "Stun Trap" },
            { "Pea Soup Trap", "Disarm Trap" },
            { "Person Trap", "Hey! Trap" },
            { "Phone Trap", "Hey! Trap" },
            { "Pie Trap", "Frost Trap" },
            { "Pikmin Trap", "Hey! Trap" },
            //{ "Pinball Trap", "" },
            { "Pincercrab", "Stun Trap" },
            //{ "Pixelate Trap", "" },
            //{ "Pixellation Trap", "" },
            //{ "Player Money Trap", "" }, //Could reduce how much money the players have?
            { "Poison Mushroom", "Poison Trap" },
            { "Poisontoad", "Poison Trap" },
            ...
            { "PSP Trap", "crt_trap" },
            //{ "Puppet Spider", "" }, //Could force use one of the player's extra abilities?
            //{ "Push Trap", "" },
            ...
            { "Shrink Trap", "Disarm Trap" },
            { "Shuffle Trap", "Confuse Trap" },
            { "Sinking Trap", "Bomb Trap" },
            ...
            //{ "Snake Trap", "" },
            { "Spam Trap", "Hey! Trap" },
            { "Speed Up Trap", "explore_speed_trap" },
            ...
            { "Stinky Trap", "Poison Trap" },
            { "Stutter Trap", "Stun Trap" },
            //{ "Sudden Trap", "" },
            { "Summon Trap", "Chaser Trap" },
            { "SvC Effect", "Banner Trap" },
            //{ "Swap Trap", "" },
            { "Syntax Jumpscare Trap", "Hey! Trap" },
            { "Tar Trap", "Frost Trap" },
            ...
            { "TNT Trap", "Bomb Trap" },
            //{ "Tool Swap Trap", "" },
            { "Toxin Trap", "Poison Trap" },
            { "Transmute Trap", "Disarm Trap" },
            { "Trivia Trap", "Hey! Trap" },
            { "Tutorial Trap", "Hey! Trap" },
            //{ "Underwater Trap", "" },
            { "Undo Trap", "home_tp_trap" },
            //{ "UNO Challenge", "" },
            { "Vintage Trap", "crt_trap" },
            { "Wailnard", "Stun Trap" },
            { "Well Done Trap", "Hey! Trap" },
            //{ "W I D E Trap", "" },
            { "Whirlpool Trap", "Bomb Trap" },
            { "Whoops! Trap", "home_tp_trap" },
            { "Yap Trap", "Hey! Trap" },
            { "Zoom In Trap", "curvature_trap" },
            { "Zoom Out Trap", "curvature_trap" },
            { "Zoom Trap", "curvature_trap" },
        };
        ...
        public static readonly Dictionary<string, List<string[]>> gameFuzzyItemNameToXML = new Dictionary<string, List<string[]>>()
        {
            { "", new List<string[]>()
            {
                ...
                new string[]{ "Station", "doodads/generic/deco_vendor_cart.xml" },
                ...
                new string[]{ "Shell", "actors/tick_1.xml:north" },
            ...
            { "Hollow Knight", new List<string[]>()
            {
                ...
                new string[]{ "Stag", "doodads/generic/deco_vendor_cart.xml" },
            }},
